module.exports = [
"[project]/node_modules/.pnpm/lexical@0.35.0/node_modules/lexical/Lexical.dev.mjs [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const COMPOSITION_SUFFIX = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : ZERO_WIDTH_SPACE;
const DOUBLE_LINE_BREAK = '\n\n';
// For FF, we need to use a non-breaking space, or it gets composition
// in a stuck state.
const COMPOSITION_START_CHAR = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : COMPOSITION_SUFFIX;
    ...
    try {
        updateEditorSync(editor, ()=>{
            ...
            if (selection !== null) {
                ...
                if (IS_FIREFOX && isFirefoxClipboardEvents(editor)) //TURBOPACK unreachable
                ;
            }
        });
    } finally{
 ...
 */ class StateConfig {
    /** The string key used when serializing this state to JSON */ /** The parse function from the StateValueConfig passed to createState */ /**
...
function $shouldPreventDefaultAndInsertText(selection, domTargetRange, text, timeStamp, isBeforeInput) {
    ...
    const domSelection = getDOMSelection(getWindow(editor));
    const domAnchorNode = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : null;
            ...
            if ($isRangeSelection(selection)) {
                ...
                if (isPossiblyAndroidKeyPress(event.timeStamp) && editor.isComposing() && isSelectionAnchorSameAsFocus) {
                    ...
                    if (!shouldLetBrowserHandleDelete) {
                        ...
                        if (IS_ANDROID_CHROME && $isRangeSelection(selectionAfterDelete) && selectionAfterDelete.isCollapsed()) //TURBOPACK unreachable
                        ;
                    }
                }
                return;
...
function onInput(event, editor) {
    ...
    updateEditorSync(editor, ()=>{
        ...
        if (data != null && $isRangeSelection(selection) && $shouldPreventDefaultAndInsertText(selection, targetRange, data, event.timeStamp, false)) {
            ...
            ;
            const isBackward = undefined;
            const startOffset = undefined;
            const endOffset = undefined;
            const textLength = undefined;
        } else {
...
function onKeyDown(event, editor) {
    ...
    } else if (isOpenLineBreak(event)) //TURBOPACK unreachable
    ;
        ...
        event.preventDefault();
        dispatchCommand(editor, DELETE_WORD_COMMAND, false);
    } else if (isDeleteLineBackward(event)) //TURBOPACK unreachable
    ;
    else if (isDeleteLineForward(event)) //TURBOPACK unreachable
    ;
...
class LexicalNode {
    ...
    /** @internal */ /** @internal */ //@ts-ignore We set the key in the constructor.
    /** @internal */ /** @internal */ /** @internal */ /** @internal */ // Flow doesn't support abstract classes unfortunately, so we can't _force_
...
class RangeSelection {
   ...
   */ modify(alter, isBackward, granularity) {
        ...
        //TURBOPACK unreachable
        ;
        const blockCursorElement = undefined;
        const rootElement = undefined;
        const focusNode = undefined;
    }
    /**
...
class ElementNode extends LexicalNode {
    /** @internal */ /** @internal */ /** @internal */ /** @internal */ /** @internal */ /** @internal */ /** @internal */ /** @internal */ /** @internal */ constructor(key){
        super(key);
        this.__first = null;
        this.__last = null;
        this.__size = 0;
...
class LexicalEditor {
    /** The version with build identifiers for this editor (since 0.17.1) */ /** @internal */ /** @internal */ /** @internal */ /** @internal */ /** @internal */ /** @internal */ /** @internal */ /** @internal */ /** @internal */ /** @internal */ /** @internal */ /** @internal */ /** @internal */ /** @internal */ /** @internal */ /** @internal */ /** @internal */ /** @internal */ /** @internal */ /** @internal */ /** @internal */ /** @internal */ /** @internal */ /** @internal */ /** @internal */ /** @internal */ /** @internal */ /** @internal */ /** @internal */ /** @internal */ /** @internal */ constructor(editorState, parentEditor, nodes, config, onError, htmlConversions, editable, createEditorArgs){
...
//# sourceMappingURL=ddef9_lexical_Lexical_dev_mjs_9be41e04._.js.map